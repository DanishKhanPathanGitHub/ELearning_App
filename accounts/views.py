...
def reset_password_allow(allow=False):
...
def reset_password_validate(request, uidb64, token):
    ...
    if user is not None and default_token_generator.check_token(user, token):
        ...
        print('setting reset_password_allow true')
        reset_password_allow(allow=True)
        print('set succesfully reset_password_allow as true ')
