...
urlpatterns = [
    ...
    path('classrroom/<int:id>/LecturePlaylists/<int:pid>/', views.SpecificPlaylist, name='SpecificPlaylist'),
    path('classrroom/<int:id>/LecturePlaylists/<int:pid>/Lecture/<int:lid>/', views.SpecificLecture, name='Lecture'), 
