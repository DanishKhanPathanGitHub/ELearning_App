...
urlpatterns = [
    ...
    path('classroom/<int:id>/LecturePlaylist/<int:pid>/SpecificLecture/<int:lid>/', views.SpecificLecture, name='tutorSpecificLecture'), 
    path('classroom/<int:id>/LecturePlaylist/<int:pid>/add_lecture/', views.LectureAdd, name='lecture_add'), 
